...
//           <a href="/about"><li className="cursor-pointer hover:text-gray-600 transition">About</li></a>
//           <a href="/skills"><li className="cursor-pointer hover:text-gray-600 transition">Skills</li></a>
//           <a href="/projects"><li className="cursor-pointer hover:text-gray-600 transition">Projects</li></a>
//           <a href="/experience"><li className="cursor-pointer hover:text-gray-600 transition">Experience</li></a>
//           <a href="/contact"><li className="cursor-pointer hover:text-gray-600 transition">Contact</li></a> 
//         </ul>
...
//       {/* Mobile Menu */}
//       {menuOpen && (
//         <div className="md:hidden bg-[#e7e7e7] px-6 pt-4 pb-6 space-y-4">
//           <ul className="flex flex-col gap-4 font-bold text-sm">
//             <li className="cursor-pointer hover:text-gray-600 transition">About</li>
//             <li className="cursor-pointer hover:text-gray-600 transition">Skills</li>
//             <li className="cursor-pointer hover:text-gray-600 transition">Projects</li>
//             <li className="cursor-pointer hover:text-gray-600 transition">Experience</li>
